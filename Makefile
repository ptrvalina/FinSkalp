...
test:
	...
	cd flowsint-crypto-compliance && uv run pytest

sovereign-tron-up:
	@echo "Starting FinSkalp sovereign TRON FullNode..."
	cd flowsint-crypto-compliance && bash scripts/setup_sovereign_tron.sh
