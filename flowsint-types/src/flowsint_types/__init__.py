...
TYPE_TO_MODEL: Dict[str, Type[BaseModel]] = {
    ...
    "cryptonft": CryptoNFT,
    "fiatlegevent": FiatLegEvent,
    "licensedplatformevent": LicensedPlatformEvent,
    "controlpurchaseevent": ControlPurchaseEvent,
    "cryptocluster": CryptoCluster,
    "fiatcryptobridge": FiatCryptoBridge,
    "bankregulatorfeed": BankRegulatorFeed,
    "sovereignrisklabel": SovereignRiskLabel,
    "fusedattribution": FusedAttribution,
    "walletscreeningresult": WalletScreeningResult,
    "website": Website,
    "port": Port,
    "phrase": Phrase,
    "breach": Breach,
