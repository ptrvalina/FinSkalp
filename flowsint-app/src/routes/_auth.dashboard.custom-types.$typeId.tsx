...
import { FusionPlatformShell, FusionPlatformEditor, FusionSkeleton } from '@/fusion'
...
function CustomTypeEditor() {
  ...
  if (!isNew && isLoading) {
    return (
      <FusionPlatformShell title="Schema Architect" subtitle="Loading type…" activeSection="types">
        <FusionSkeleton rows={8} variant="row" />
      </FusionPlatformShell>
    )
  }
  ...
  return (
    <FusionPlatformShell
      ...
      subtitle={isNew ? 'New type' : name || 'Untitled'}
      activeSection="types"
    >
          ...
          <>
            <div className="flex items-center gap-3 min-w-0">
              <Button
                variant="ghost"
                size="sm"
                className="h-8 px-2 text-[var(--fusion-text-secondary)] hover:text-[var(--fusion-text-primary)]"
                onClick={() => navigate({ to: '/dashboard/custom-types' })}
              >
                <ArrowLeft className="w-4 h-4 mr-1.5" />
                <span className="text-sm">Types</span>
              </Button>
              <span className="text-[var(--fusion-text-tertiary)]">/</span>
              <span className="text-sm text-[var(--fusion-text-secondary)] truncate max-w-[200px]">
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="ghost"
                size="sm"
                className="h-8 text-[var(--fusion-text-secondary)]"
      ...
      <div className="max-w-6xl mx-auto">
        <div className={showPreview ? 'flex gap-10' : ''}>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-2 min-w-0">
                  <input
                    ...
                    className="w-full text-3xl font-bold bg-transparent border-none outline-none placeholder:text-[var(--fusion-text-tertiary)] text-[var(--fusion-text-primary)] tracking-tight"
                  />
                  <textarea
                    value={description}
                    ...
                    rows={1}
                    className="w-full text-sm bg-transparent border-none outline-none placeholder:text-[var(--fusion-text-tertiary)] text-[var(--fusion-text-secondary)] resize-none leading-relaxed"
                    onInput={(e) => {
          ...
          {/* Right: Preview panel */}
          {showPreview && (
            <div className="border-l border-[var(--fusion-border)] pl-8">
